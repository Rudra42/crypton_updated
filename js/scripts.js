...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        $(window).load(function () {
            $(".typing").typed({
                strings: ["I am A Freelancer.", "I Design Websites.", "I am from Bangladesh."],
        ...
        $('.skillbar').each(function () {
            $(this).find('.skillbar-barone').animate({
                width: $(this).attr('data-percent')
            }, 6100);
        });
        $('.skillbar').each(function () {
            $(this).find('.skillbar-bartwo').animate({
                width: $(this).attr('data-percent')
            }, 6100);
        });
        $('.skillbar').each(function () {
            $(this).find('.skillbar-barthree').animate({
                width: $(this).attr('data-percent')
            }, 6100);
        });
        $('.skillbar').each(function () {
            $(this).find('.skillbar-barfour').animate({
                width: $(this).attr('data-percent')
            }, 6100);
        });
        $('.skillbar').each(function () {
            $(this).find('.skillbar-barfive').animate({
                width: $(this).attr('data-percent')
            }, 6100);
        });
            ...
            markers: [
                {
                    ...
                    html: "<b>Address</b>: <br> Bashundhara R\A, Dhaka, Bangladesh.",
